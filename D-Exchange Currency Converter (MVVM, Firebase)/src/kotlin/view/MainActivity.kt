...
class MainActivity : AppCompatActivity(), CurrenciesFragment.OnListFragmentInteractionListener {
    ...
    override fun onCreate(state: Bundle?) {
        ...
        ConHelp.conGet = {this}
        market = ViewModelProvider(this)[Market::class.java]
    ...
    private fun shareApp() = try{
        ...
        shareIntent.putExtra(Intent.EXTRA_SUBJECT, "D-Exchange")
        val link = "https://play.google.com/store/apps/details?id=dev.daryl.d_exchange"
